		...
		<div class="row g-2 items-center">
			<div class="col col-12 col-lg-6">
				<div class="hstack gap-1">
					...
					<a href="{{LaravelLocalization::localizeUrl( route('elseyyid.translations.home') )}}" class="page-pretitle flex items-center">
						/ {{__('Manage Languages')}}
					</a>
				</div>
			...
			<div class="col col-12 col-lg-6">
				<div class="flex">
					@if(!activeRoute('elseyyid.translations.lang'))
						<a href="{{route('elseyyid.translations.lang.reinstall')}}" class="btn btn-default flex space-x-2 mr-2 lg:ml-auto">
					...
					<button @if($app_is_demo) type="button" onclick="return toastr.info('This feature is disabled in Demo version.')" @else type="submit" @endif class="btn btn-default flex space-x-2 mr-2 lg:ml-auto" onClick="return handlePromptInput()">
					...
					<form action="{{ route('elseyyid.translations.lang.newString') }}" class="relative hidden" id="new-string-form" method="GET">
					...
					<a @if($app_is_demo) href="javascript:void(0);" onclick="return toastr.info('This feature is disabled in Demo version.')" @else href="{{route('elseyyid.translations.lang.publishAll')}}" @endif class="btn btn-primary flex space-x-2">

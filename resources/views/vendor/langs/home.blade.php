        ...
        <div class="row">
            <div class="lang-switcher card card-body mb-3 py-2 px-3 flex flex-row items-center justify-between">
                ...
                <div class="flex space-x-1">
                    ...
                    <a href="{{route('elseyyid.translations.lang','edit')}}" class="btn border-none shadow-none">{{__('Edit default strings')}}</a>
                </div>
            </div>
            <hr class="mt-3 mb-4">
                    ...
                    <div class="flex space-x-1">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{route('elseyyid.translations.lang',$lang)}}" class="dropdown-item px-3 py-2 border-solid border-[--tblr-border-color] border-t-0 border-r-0 border-l-0 last:border-b-0 text-heading transition-colors hover:no-underline hover:bg-[--tblr-border-color]">
                                ...
                                <a @if($app_is_demo) href="javascript:void(0);" onclick="return toastr.info('This feature is disabled in Demo version.')" @else href="{{route('elseyyid.translations.lang.generateJson',$lang)}}" @endif class="dropdown-item px-3 py-2 border-solid border-[--tblr-border-color] border-t-0 border-r-0 border-l-0 last:border-b-0 text-heading transition-colors hover:no-underline hover:bg-[--tblr-border-color]">

...
@includeWhen(in_array($settings_two->chatbot_status && ($settings_two->chatbot_login_require == false || $settings_two->chatbot_login_require == true && auth()->check()), ['frontend', 'both']), 'panel.chatbot.widget')

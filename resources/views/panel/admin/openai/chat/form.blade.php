        ...
        <div class="container-xl">
			<div class="row">
				<div class="col-md-5 mx-auto">
					<form class="@if(view()->exists('panel.admin.custom.layout.panel.header-top-bar')) bg-[--tblr-bg-surface] px-8 py-10 rounded-[--tblr-border-radius] @endif" id="custom_template_form" onsubmit="return templateChatSave({{$template!=null ? $template->id : null}});" action="" enctype="multipart/form-data">

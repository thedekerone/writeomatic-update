					...
					<table class="table">
                        ...
                        @if($app_is_not_demo)
                            @foreach($users as $entry)
                                <tr>
                                    ...
                                    <td class="sort-status">{{$entry->status == 1 ? __('Active') : __('Passive') }}</td>
                                    ...
                                    <td class="!text-end whitespace-nowrap">
                                        <a href="{{route('dashboard.admin.users.finance', $entry->id)}}" class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white open-modal-link" title="{{__('Finance Management')}}">
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td class="!text-end whitespace-nowrap">
                                    <a onclick="return toastr.error('You cannot edit or remove user in demo mode!')" class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white" title="{{__('Finance Management')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg"  width="19" height="19"  viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <path d="M16.7 8a3 3 0 0 0 -2.7 -2h-4a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6h-4a3 3 0 0 1 -2.7 -2" />
                                            <path d="M12 3v3m0 12v3" />

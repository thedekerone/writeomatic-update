        ...
        <div class="card text-heading">
            <div class="card-body flex flex-col p-4 px-8 py-6">
                <ul>
                    <li>
                        <a href="#">
                            <img class="h-auto w-full" src="{{ asset('images/team/icon2.png') }}" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                    ...
                    <li>
                        <a href="#">
                            <img class="h-auto w-full" src="{{ asset('images/team/icon3.png') }}" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img class="h-auto w-full" src="{{ asset('images/team/icon4.png') }}" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img class="h-auto w-full" src="{{ asset('images/team/icon5.png') }}" alt="">
                        </a>
                    </li>
                </ul>

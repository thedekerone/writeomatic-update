                    ...
                    <div class="col-12 col-md-6 ms-auto">
                        <div class="d-flex md:justify-content-end w-full justify-center">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                >{{ $team->members->count() }}</p>
                                <p class="mb-0 p-0">@lang('Allowed Seats'): <b class="text-heading fw-bold">{{ $team->allow_seats }}</b></p>
                                <p class="mb-0 p-0">@lang('Total Words Generated'): <b class="text-heading fw-bold">{{ $team->members?->sum('used_word_credit') }}</b></p>
                                <p class="mb-0 p-0">@lang('Total Images Generated'): <b class="text-heading fw-bold">{{ $team->members?->sum('used_image_credit') }}</b></p>
                            </div>
                        </div>
                    </div>
                </div>

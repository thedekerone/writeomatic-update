@if ($openai->type == 'image')
        ...
        >
            ...
            <div class="lqd-modal-img-content-wrap relative z-10 my-auto max-h-[90vh] w-full overflow-y-auto">
                <div class="container max-w-6xl">
                    <div class="lqd-modal-img-content relative flex flex-wrap justify-between rounded-xl bg-[--tblr-body-bg] !p-5 xl:min-h-[570px]">
                        <a
                            class="absolute end-2 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full border bg-[--tblr-body-bg] text-inherit shadow-sm transition-all hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black"
                        ...
                        <div
                            class="lqd-modal-img-img relative aspect-square min-h-[1px] w-full rounded-lg bg-cover bg-center max-md:min-h-[350px] md:!w-6/12"
                            :style="{ backgroundImage: `url(${activeItem?.output})` }"
                        >
                            <a
                                class="absolute !bottom-7 !end-7 inline-flex h-9 w-9 items-center justify-center rounded-full bg-[--tblr-body-bg] text-inherit shadow-sm transition-all hover:scale-105"
                                href="#"
                        ...
                        <!-- Prev/Next buttons -->
                        <a
                            class="absolute -start-5 top-1/2 z-10 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-[--tblr-body-bg] text-inherit shadow-sm transition-all hover:scale-110 hover:bg-[--tblr-primary] hover:text-white"
                            href="#"
                        ...
                        <a
                            class="absolute -end-5 top-1/2 z-10 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-[--tblr-body-bg] text-inherit shadow-sm transition-all hover:scale-110 hover:bg-[--tblr-primary] hover:text-white"
                            href="#"
    ...
    <template id="image_result">
        <div class="col-6 col-md-4 col-xl-2 mb-8">
            <div
                class="image-result group"
                :class="{ 'info-showing': modalShow && activeItemId == $el.getAttribute('data-id') }"
            >
                <div class="relative mb-2 aspect-square overflow-hidden rounded-lg transition-all group-hover:shadow-lg">
                    <img
                    ...
                    <div class="absolute left-0 top-0 flex h-full w-full items-center justify-center gap-2 opacity-0 transition-opacity group-hover:!opacity-100">
                        <a
                            class="btn download h-9 w-9 items-center justify-center p-0"
                            href=""
                            download
                        >
                            <svg
                        ...
                        <a
                            class="btn lb gallery h-9 w-9 items-center justify-center p-0"
                        ...
                        <a
                            class="btn delete h-9 w-9 items-center justify-center p-0"
                            href=""
                ...
                <p
                    class="text-heading mb-1 w-full overflow-hidden overflow-ellipsis whitespace-nowrap"
                    title=""
                >
                </p>
            ...
            <tbody>
                @foreach ($userOpenai as $entry)
                    ...
                    <tr class="text-[13px]">
                        <td>{{ $entry->title }}</td>
                        <td class="text-[11px]">
                            <span class="inline-block rounded-sm bg-black/[0.06] px-[6px] py-[3px] dark:bg-white/[0.06]">
                        ...
                        <td>
                            <a
                                class="btn relative z-10 h-[36px] w-[36px] border p-0 hover:bg-[var(--tblr-primary)] hover:text-white"
                            ...
                            <a
                                class="btn relative z-10 h-[36px] w-[36px] border p-0 hover:bg-red-600 hover:text-white"
            ...
            <tbody>
                @foreach ($userOpenai as $entry)
                    <tr>
                        <td class="text-muted">
                            <span
                                class="avatar h-[43px] w-[43px] [&_svg]:h-[20px] [&_svg]:w-[20px]"
                        ...
                        @elseif($openai->type == 'code')
                            <td>
                                <div class="mt-[15px] min-h-full border-b-0 border-l-0 border-r-0 border-t border-solid border-[var(--tblr-border-color)] pt-[30px]">
                                    <pre
                ...
                fetch(
                    ...
                    .then(data => {
                        ...
                        images.forEach(image => {
                            ...
                            let galleryDiv = imageResultTemplate.querySelector('.image-result a.gallery');

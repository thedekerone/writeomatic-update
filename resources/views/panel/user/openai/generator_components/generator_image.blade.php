    ...
    <div class="row row-deck row-cards">
                                    ...
                                    <div class="flex flex-wrap justify-between gap-3 mt-8">
                                        ...
                                        <div class="grow">
                                            ...
                                            <select
                                                ...
                                                name="size" id="size" @if($app_is_demo) onclick="handleSelectChange(this)" @endif>
        ...
        <template id="prompt-template">
            <div class="each-prompt d-flex align-items-center mt-3">
                ...
                <button type="button" class="bg-transparent border-none text-heading" data-toggle="remove-parent">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="24px" height="24px" fill="currentColor">
                        <path

...
@section('script')
    <script
        src="/assets/libs/tom-select/dist/js/tom-select.base.min.js?1674944402"
        defer
    ></script>
    <script src="/assets/js/panel/openai_generator.js"></script>
    <script
        src="/assets/libs/fslightbox/index.js?1674944402"
        defer
    ></script>
    ...
    @if ($openai->type == 'code')
        <link
            rel="stylesheet"
            href="/assets/libs/prism/prism.css"
        >
                    ...
                    setTimeout(function() {
                        @if ($openai->type == 'image')
                            ...
                            images.forEach((image) => {
                                ...
                                console.log(imageResultTemplate.querySelector('.image-result'));

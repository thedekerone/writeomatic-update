                            ...
                            @foreach ($list as $entry)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">
                                        @if (!$entry->system)
                                            <a href="{{ route('dashboard.email-templates.send', $entry->id) }}"
                                                class="btn w-[36px] h-[36px] p-0 border hover:bg-red-500 hover:text-white"
                                                title="send">
                                                <svg width="13" height="13" xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-send" stroke-width="2"
                                        ...
                                        @else
                                            @if ($entry->role != 'default')
                                                <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.email-templates.edit', $entry->id)) }}"
                                                    class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white"
                                                    title="{{ __('Edit') }}">
                                                    <svg width="13" height="12" viewBox="0 0 16 15" fill="none"
                                                        stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @if (!$entry->system)
                                            <a href="{{ route('dashboard.email-templates.destroy', $entry->id) }}"

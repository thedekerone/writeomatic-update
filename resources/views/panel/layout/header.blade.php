        ...
        <div class="container-fluid p-0 max-lg:w-full">
            ...
            <div class="navbar-collapse collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:px-3 max-lg:py-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_pdf') == url()->current() ? 'active' : '' }}"
                               href="{{ route('dashboard.user.openai.generator.workbook', 'ai_pdf') }}">
                                <span class="nav-link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-pencil" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ route('dashboard.user.openai.webchat.workbook') == url()->current() ? 'active' : '' }}"
					...
					@if ($setting->feature_ai_voice_clone && $settings_two->elevenlabs_api_key)
                        ...
                        <li class="nav-item">
                            ...
                            <span class="nav-link-icon">
								<svg xmlns="http://www.w3.org/2000/svg" class="svgclone" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 12.9a5 5 0 1 0 -3.902 -3.9" /><path d="M15 12.9l-3.902 -3.899l-7.513 8.584a2 2 0 1 0 2.827 2.83l8.588 -7.515z" /></svg>
                            </span>
                                <span class="nav-link-title flex grow items-center transition-[opacity,transform]">
                                {{ __('AI Voice Clone') }}
                            </span>
                    ...
                    @if (Auth::user()->type == 'admin')
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ activeRouteBulk('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.chat.*', 'dashboard.admin.openai.categories.list', 'dashboard.admin.openai.categories.*') }}"
                            ...
                            <div
                                    class="dropdown-menu {{ activeRouteBulkShow('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.custom.*', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.chat.*', 'dashboard.admin.openai.categories.list', 'dashboard.admin.openai.categories.*', 'dashboard.email-templates.*') }}">

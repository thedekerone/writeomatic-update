<header @class([
    ...
    <nav
        ...
        @class([
            'relative flex items-center justify-between border-b border-opacity-10 px-7 py-4 text-[14px] opacity-0 transition-all duration-500 group-[.lqd-is-sticky]/header:border-black group-[.lqd-is-sticky]/header:border-opacity-5 group-[.page-loaded]/body:opacity-100 max-sm:px-2',
            'border-black' =>
        ...
        <div class="flex basis-1/3 justify-end gap-2 max-lg:basis-2/3">
            ...
            @auth
                <x-button
                    ...
                    label="{!! __('Dashboard') !!}"
                    border="border-[2px] {{ isset($page) && $page->titlebar_status ? 'border-white' : 'border-black' }} !border-opacity-0"
                    bg="{{ isset($page) && $page->titlebar_status ? 'bg-white' : 'bg-black' }} !bg-opacity-10 hover:!bg-opacity-100 group-[.lqd-is-sticky]/header:bg-black group-[.lqd-is-sticky]/header:hover:!bg-opacity-100"
                    text="{{ isset($page) && $page->titlebar_status ? 'text-white' : 'text-black' }} group-[.lqd-is-sticky]/header:text-black group-[.lqd-is-sticky]/header:hover:text-white"
                />
            @else
                <x-button
                    ...
                    type="outline"
                    border="border-[2px] {{ isset($page) && $page->titlebar_status ? 'border-white' : 'border-black' }} !border-opacity-10 group-[.lqd-is-sticky]/header:border-black"
                    text="{{ isset($page) && $page->titlebar_status ? 'text-white' : 'text-black' }} group-[.lqd-is-sticky]/header:text-black group-[.lqd-is-sticky]/header:hover:text-white"
                />
                <x-button

...
class StripeControllerElements extends Controller
{
     ...
     */
    public function subscribePay(Request $request, $referral = null)
    {
                ...
                if($intent != null){
                    ...
                    if($intent->client_secret == $payment_intent_client_secret){
                        ...
                        if($intent->status=="succeeded"){
                            ...
                            return redirect()->route('dashboard.'.auth()->user()->type.'.index')->with([
                                'message' => 'Thank you for your purchase. Enjoy your remaining words and images.', 
                                'type' => 'success'
                            ]);
     ...
     */
    public function prepaidPay(Request $request, $referral = null)
    {
        $previousRequest = app('request')->create(url()->previous());

...
async function fetchUnsplashImages(
  ...
  if (
    ...
    response =
      await fetch(
        `https://api.unsplash.com/search/photos?page=${page}&query=${query}&client_id=${unsplashKey}`,
      )
  else
    response =
      await fetch(
        `https://api.unsplash.com/photos?page=${page}&client_id=${unsplashKey}`,
      )
  let data =
    await response.json()
  return query
    ...
    const tinymceOptions =
      {
        ...
        contextmenu:
          'customwrite |  rewrite summarize makeitlonger makeitshorter improvewriting translatetospanish fixgrammaticalmistakes | copy paste',
        toolbar:
          'styles | magicIconRewrite | magicAIButton | image | link | forecolor backcolor emoticons | bold italic underline  | bullist numlist | alignleft aligncenter alignright unsplash',
        directionality:
          document
            .documentElement
            .dir ===
                ...
                rewrite:
                  {
                    ...
                    onAction:
                      function () {
                        ...
                        formData.append(
                          'prompt',
                          'Rewrite below content professionally',
                        )
                        formData.append(
                          'content',
                          editor.selection.getContent(),
                ...
                summarize:
                  {
                    ...
                    onAction:
                      function () {
                        ...
                        formData.append(
                          'prompt',
                          'Summarize below content professionally',
                        )
                        formData.append(
                          'content',
                          editor.selection.getContent(),
                ...
                improvewriting:
                  {
                    ...
                    onAction:
                      function () {
                        ...
                        formData.append(
                          'prompt',
                          'Improve writing of  below content',
                        )
                        formData.append(
                          'content',
                          editor.selection.getContent(),
                ...
                translatetospanish:
                  {
                    ...
                    onAction:
                      function () {
                        ...
                        formData.append(
                          'prompt',
                          'Translate below content to Spanish',
                        )
                        formData.append(
                          'content',
                          editor.selection.getContent(),
                ...
                setTimeout(
                  () => {
                    ...
                    $(
                      ...
                      '<input id="custom_prompt" type="text" class="w-full" placeholder="What would you like to do?">',
                    )
                    ...
                    $(
                      ...
                      '<p class="tox-custom-label" id="quick_label">QUICK ACTIONS</p>',
                    )

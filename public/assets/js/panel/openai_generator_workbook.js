const tinymceOptions = {
	...
	// 	const externalToolbarTargetId = el.getAttribute('data-external-toolbar');

	// 	if ( !externalToolbarTargetId ) return;

	// 	const toolbar = container.querySelector('.tox-editor-header');
	// 	const externalToolbarEl = document.querySelector(externalToolbarTargetId);
	// 	const toolbarClone = toolbar.cloneNode(true);

	// 	externalToolbarEl.appendChild(toolbarClone);
	// },
